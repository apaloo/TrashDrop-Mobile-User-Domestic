...
/**
 * Social login buttons component - Google only (Apple hidden for now)
 */
const SocialLogin = ({ isSubmitting = false, onError = null }) => {
  ...
  const handleGoogleSignIn = async () => {
    try {
      ...
      console.error('[SocialLogin] Google sign-in error:', error);
      if (onError) {
