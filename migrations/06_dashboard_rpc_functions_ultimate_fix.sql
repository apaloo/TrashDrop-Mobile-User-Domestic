-- ULTIMATE FIX: Resolve ALL remaining ambiguous column references
-- This replaces the entire get_dashboard_data_optimized function with completely qualified columns
