          ...
          <div className="border border-gray-200 rounded-xl p-6 bg-gray-50">
            ...
            <div className="mb-6 p-5 bg-white rounded-xl border border-gray-200">
              <div className="flex justify-between items-center mb-1">
                ...
                <span className="text-gray-700">GHS {RATE_PER_BAG.toFixed(2)} per bag</span>
              </div>
              <div className="h-px bg-gray-100 my-3"></div>
              <div className="flex justify-between items-center">
                <span className="text-gray-700 font-semibold text-lg">Total Charge:</span>
                <span className="text-2xl font-bold text-blue-600">
                  GHS {charge.toFixed(2)}
                </span>
              </div>
            </div>
        ...
        <div className="bg-white rounded-2xl shadow-lg p-8">
          ...
          <div className="mt-8">
            <button
              ...
              className="w-full py-4 px-6 bg-blue-600 hover:bg-blue-700 text-white text-lg font-medium rounded-xl shadow-md transition-colors"
            >
